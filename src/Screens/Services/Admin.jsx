...
const Architecture = () => {
  ...
  const tabData = {
    ...
    faq: {
      ...
      faqs: [
        ...
        {
          question: "What type of firms can benefit from virtual admin services?",
          answer:
        ...
        {
          question: "Can a virtual admin assist with construction documentation and submittals?",
          answer:
  ...
  const activeGradient = "linear-gradient(744deg, #2F2F2F, #7F7F7F 60%, #D3D3D3)";
  ...
  return (
    <div className="min-h-screen">
      ...
      <motion.div
        ...
        className={`z-20 bg-gray-500 backdrop-blur-xl shadow-lg transition-all duration-300 ${isSticky ? "fixed top-[64px] left-0 right-0 shadow-xl" : "relative"
          }`}
      >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 gap-2">
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <span className="text-[#0d3557] uppercase regular text-[14px]">{feature.name}</span>
                  </motion.div>
                ))}
              </div>
