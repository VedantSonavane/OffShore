...
const Architecture = () => {
  ...
  const activeGradient = "linear-gradient(744deg, #FF8C00, #FFD700 60%, #FFFACD)";
          ...
          <div className="max-w-full    ">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {tabData.plans.plans.slice(0, 5).map((plan, index) => (
                ...
                >
                  {/* Wave Effect for Each Card with Multiple Shades of Amber and Yellow */}
                  {[...Array(3)].map((_, i) => (
                    <div
                      key={`wave-${index}-${i}`}
